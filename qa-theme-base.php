...
*/
...

	{
		...
		if (!empty($q_view)) {
			...
			$this->output('<div><a href="https://www.bidbarg.com/?cd=&b=1stbanerb"><img alt="حل سریع مشکل شما با مشاوره تلفنی یا حضوری" src="https://www.bidbarg.com/bimeh/pic/moshavere.gif"/></a>  </div>');
